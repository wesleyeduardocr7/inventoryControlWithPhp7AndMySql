...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Itens do Pedido de Entrada
    </h1>
    <ol class="breadcrumb">
      <li><a href="/"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="/">Itens de Pedido</a></li>
      <li class="active"><a href="/admin/stockordersitem-input/create">Cadastrar</a></li>
    </ol>
  </section>
    ...
    <div class="row">
      <div class="col-md-12">        
        <div class="box box-success">
          ...
          <!-- form start -->
            <form role="form" action="/admin/stockordersitem-input/create/<?php echo htmlspecialchars( $idbranch, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $iduser, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $idstockorder, ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="get">
                  <div class="box-body">              
          ...
          <!-- form start -->
          <form role="form" action="/admin/stockordersitem-input/additem" method="get">
            <div class="box-body">
          ...
          <!-- form start -->
        <form role="form" action="/admin/stockordersitem-input/additem/<?php echo htmlspecialchars( $idproduct, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $idstockorder, ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
        ...
        <?php } ?> 
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>                 
                    ...
                    <td><a href="/admin/stockordersitem-input/deleteitem/<?php echo htmlspecialchars( $idstockorder, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $value1["idstockorderitem"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Cancelar Pedido</a></td> 
                  </tr>
                  <?php } ?>
                </tbody>
                <tfoot>
          ...
          <a href="/admin/stockorders-input/create/checkout/<?php echo htmlspecialchars( $idstockorder, ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="width: 90px; margin-top: 50px;" class="btn btn-primary">Concluir</a>
          <a href="/admin/stockorders-input/create/<?php echo htmlspecialchars( $idbranch, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $iduser, ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="width: 90px; margin-top: 50px;" class="btn btn-danger">Cancelar</a>
